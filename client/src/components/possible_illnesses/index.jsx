...
class PossibleIllnesses extends React.Component {
  ...
  onSelectMedicine = medicine => {
    ...
    if (!!patientFile.patient) {
      const medicineIndex = this
        .state
        .selectedMedicines
        .findIndex(m => isEqual(m, medicine));
      if (medicineIndex === -1) {
        ...
        this.setState({
          selectedMedicines: this
            .state
            .selectedMedicines
            .filter(m => m.value !== medicine.value)
        }, () => {
          this
            .props
            .matchAllergens({
  ...
  render() {
    ...
    const {diagnosis, illnesses, medicines, allergenMedicines, pendingAllergenMedicines} = this.props;
      ...
      <div>
        ...
        <Distribution
          ...
          return {
            ...
            onClick: () => {
              ...
              this.setState({selectedIllness: i, selectedMedicines: [], showForm: true});
              this
                .props
                .fetchMedicines(i.id);
            }
        ...
        <br/>{" "} {showForm && (
          <Layer
            ...
            closer={true}
            overlayClose={true}
            onClose={() => this.setState({selectedIllness: undefined, showForm: false})}>
            <Animate
              style={{
                  ...
                  <div style={{
                    ...
                    {pendingAllergenMedicines
                      ...
                      : (<Button
                        ...
                        plain={false}
                        onClick={isEmpty(allergenMedicines)
...
const mapStateToProps = state => ({medicines: state.medicines.data, allergenMedicines: state.allergens.data, pendingAllergenMedicines: state.allergens.pending, diagnosis: state.diagnoses.data});
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(PossibleIllnesses));
